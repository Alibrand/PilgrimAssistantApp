...
public class UmrahFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_umrah_first);
        ...
        button_tawaf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(UmrahFirstActivity.this,TawafActivity.class);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(UmrahFirstActivity.this,UmrahNusukActivity.class);
    ...
    public void checkIfComplete() {
        ...
        firestore.collection("user_info")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UmrahFirstActivity.this, "حدث خطأ", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
    }
