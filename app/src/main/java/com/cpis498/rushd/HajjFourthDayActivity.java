...
public class HajjFourthDayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hajj_fourth_day);
        ...
        dialog=new ProgressDialog(HajjFourthDayActivity.this);
        button_prayers=findViewById(R.id.button_prayers);
        button_prayers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(HajjFourthDayActivity.this,PrayersActivity.class);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(HajjFourthDayActivity.this,HajjFifthDayActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void loadCurrentPhase() {
        ...
        firestore.collection("user_info")
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                NusukListAdapter adapter=new NusukListAdapter(HajjFourthDayActivity.this,phases, pilgrim.getCurrent_phase(),doc.getId(),pilgrim.getDays_check(),thisDay);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HajjFourthDayActivity.this, "حدث خطأ", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
    }
